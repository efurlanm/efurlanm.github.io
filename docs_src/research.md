...
I maintain a repository on Github with my open source projects that I have been developing over time for various purposes: <https://github.com/efurlanm/> . The current main research repository is: <https://github.com/efurlanm/ml/>. The research also uses the LNCC supercomputer [Santos Dumont](https://sdumont.lncc.br/) under the project [AMPEMI](https://sdumont.lncc.br/projects_view.php?pg=projects&status=ongoing). 

...
Based on [Parallel Spectral Numerical Methods](https://open.umich.edu/find/open-educational-resources/literature-science-arts/parallel-spectral-numerical-methods) by Chen et al. (2012) from University of Michigan.

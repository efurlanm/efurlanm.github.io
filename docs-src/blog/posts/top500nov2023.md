...
Brazil currently has 9 supercomputers on the TOP500 list (top500.org). The 500 most potent non-distributed computer systems in existence are ranked and described in detail by the TOP500 project. The last time LNCC's [SDumont](https://sdumont.lncc.br/) was included in the list, November 2022, it was in position 462.
